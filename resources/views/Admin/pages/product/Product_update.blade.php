...
<div class="card shadow-sm" style="width: 800px ;">
    <h4 class="text-center pt-5 text-black-50">Product Update</h4>
    ...
    <form action="" class="card-body">
        <div class="row pt-2">
            ...
            <div class="col-md-4">
                ...
                <input type="text" id="productCode" class="form-control shadow-none" name="txtProductCode" readonly>
            </div>
        </div>
        <div class="row pt-2">
            <div class="col-md-3">
        ...
        <div class="row p-2 pt-3">
            ...
            <input type="submit" class="btn btn-primary p-2" name="" id="" value="Update">
