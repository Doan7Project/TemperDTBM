...
<div class="card shadow-sm" style="width: 500px ;">
    ...
    <form action="" class="card-body">
        <div class="row-cols-md py-2">
            <div class="row py-2">
                <div class="col-md-4 ">
                    <label for="categoryCode" class="form-label text-black-50">Category Code</label>
                    <input type="text" id="categoryCode" name="txtCode" class="form-control shadow-none" readonly>
                </div>
                <div class="col-md-8 ">
            ...
            <div class="row-cols-md py-2">
                ...
                <input type="file" id="thumb" name="txtThumb " class="form-control shadow-none text-black" onchange="loadFile(event)">
