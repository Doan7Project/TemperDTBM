...
<div class="shadow-sm card">
    ...
    @csrf
        ...
        <div class="row-cols-md py-2">
            ...
            <input type="text" id="categoryName" name="txtCategoryName" class="form-control shadow-none" value="{{$menu->CategoryName}}" placeholder="Enter category name" readonly>
        </div>
        <div class="row-cols-md py-2">
            <label for="category" class="form-label text-black fw-bolder">Description</label>
            <textarea  rows="4" id="category" name="txtDescription" class="form-control shadow-none" placeholder="Description is not greater than 200 charater" readonly>{{$menu->Description}}</textarea>

        </div>
        <div class="row-cols-md py-2">
            <label for="content" class="text-black fw-bolder">Details</label>
            <textarea id="editor1" name="txtDetail" readonly>{{$menu->Detail}}</textarea>
